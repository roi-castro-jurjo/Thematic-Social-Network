package gal.usc.etse.grei.es.repository.support;
...
public class GenericFilterCriteriaBuilder {
    ...
    static {
        FILTER_CRITERIA.put("EQUAL", condition -> {
            ...
            if (value instanceof Integer) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Value is not a valid integer: " + value);
                }
            } else {
                throw new IllegalArgumentException("Unsupported type for integer comparison: " + value.getClass().getSimpleName());
            }

            return Criteria.where(condition.getField()).is(intValue);
        });
